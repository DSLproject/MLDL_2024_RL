...
class Agent(object):
    ...
    def update_policy(self):
        ...
        policy_losses = []
        value_losses = []
        for log_prob, value, r in zip(action_log_probs, critic_values, discounted_returns):
    ...
    def get_action(self, state, evaluation=False):
        ...
        normal_dist, value_critic = self.policy(x)
        ...
        if evaluation:  # Return mean
            ...
            return action, action_log_prob, value_critic
