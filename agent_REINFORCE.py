...
class Agent(object):
    ...
    def update_policy(self):
        ...
        # Subtract baseline from returns to compute advantages
        advantages = discounted_returns - self.baseline

        # Compute policy gradient loss function given actions and advantages
